...
class Pokemon:
    ...
    def receive_damage(self, damage):
        ...
        damage -= self.defense
        damage=damage*(1-(self.Pokemon_shield))
...
class WaterPokemon(Pokemon):
    ...
    def water_attribute(self):
        ...
        if r==1:
            self.Pokemon_shield=0.3
            print("水属性伤害减免30%")
        else:
            self.Pokemon_shield=0
            print("水属性伤害减免失败")
...
class Squirtle(WaterPokemon):
    ...
    def initialize_skills(self):
        # 初始化技能，具体技能是 AquaJet和 Shield
        return [skills.AquaJet(damage=140), skills.Shield(shield=1)]
